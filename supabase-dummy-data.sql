...
-- Reviews and orders will be created when users interact with the system

-- You can add some sample reviews after creating users:
-- INSERT INTO reviews (product_id, user_id, rating, comment) VALUES
-- ('prod-1', 'user-id-here', 5, 'Excellent camera quality!'),
-- ('prod-2', 'user-id-here', 4, 'Great features but a bit pricey');